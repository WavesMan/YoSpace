...
export const RUNTIME_CONFIG_DEFINITIONS: RuntimeConfigDefinition[] = [
  ...
  { key: "NEXT_PUBLIC_NAVIGATION_ITEMS", label: "首页导航数据", type: "string", isPublic: true, defaultValue: "[]", description: "首页导航卡片 JSON 数组字符串。" },
  { key: "NEXT_PUBLIC_PROFILE_SOCIAL_LINKS", label: "个人社交链接", type: "string", isPublic: true, defaultValue: "[]", description: "个人社交链接 JSON 数组字符串。" },
  { key: "NEXT_PUBLIC_FRIEND_LINKS", label: "友链数据", type: "string", isPublic: true, defaultValue: "[]", description: "友链列表 JSON 数组字符串。" },
  { key: "NEXT_PUBLIC_SEO_DEFAULT_OG_IMAGE", label: "SEO 默认 OG 图", type: "string", isPublic: true, defaultValue: "", description: "SEO 默认 Open Graph 图片路径。" },
  { key: "NEXT_PUBLIC_SEO_TWITTER_HANDLE", label: "SEO Twitter Handle", type: "string", isPublic: true, defaultValue: "", description: "Twitter Card 作者账号。" },
  { key: "NEXT_PUBLIC_SEO_TWITTER_SITE", label: "SEO Twitter Site", type: "string", isPublic: true, defaultValue: "", description: "Twitter Card 站点账号。" },
  { key: "NEXT_PUBLIC_SEO_SITEMAP_CHANGE_FREQUENCY", label: "SEO Sitemap 更新频率", type: "string", isPublic: true, defaultValue: "weekly", description: "sitemap changeFrequency 默认值。" },
  { key: "NEXT_PUBLIC_SEO_SITEMAP_PRIORITY", label: "SEO Sitemap 优先级", type: "number", isPublic: true, defaultValue: 0.7, description: "sitemap priority 默认值（0-1）。" },
