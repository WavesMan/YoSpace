...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const nextUsernameRaw = typeof body?.nextUsername === "string" ? body.nextUsername : verifyResult.username;
    ...
    return NextResponse.json({ message: "管理员凭证更新成功，请重新登录" });
  } catch (error) {
